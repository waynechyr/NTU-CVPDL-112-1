...
if __name__ == "__main__":
    ...
    with open('../output6.7b-coco.json', 'r') as f:
    ...
    for item in img_list:
        ...
        meta_list.append(
            dict(
                ckpt = "./gligen-generation-text-box.bin",
                prompt = item['generated_text'],
                phrases = [item['label']],
                locations = item['bboxes'],
                alpha_type = [0.3, 0.0, 0.7],
                save_folder_name="./text_prompt1",
                img_name = item['image']
            )
        )
        ...
        # dict(
        #     ckpt = "./checkpoint_inpainting_text_image.bin",
        #     input_image = "../COCODIR/train2017/"+item['image'],
        #     prompt = item['generated_prompt'],
        #     phrases = [item['label']],
        #     locations = item['bboxes'], # mask will be derived from box 
        #     save_folder_name="./text+image",
        #     img_name = item['image']
        #     )
        # )
    ...
    #     dict(
    #         ckpt = "./gligen_checkpoints/gligen-generation-text-box.bin",
    ...
    #     dict(
    #         ckpt = "./gligen_checkpoints/gligen-generation-text-image-box.bin",
